  ...
  return (
    <section className="about">
      ...
      <div className="about-experience">
        <h3 className="about-subtitle">Internships</h3>
        <ul>
          <li>
            <strong>Mahindra & Mahindra Ltd.</strong> – Software Intern (June 2024 – July 2024)
            <ul>
              <li>Worked on industrial software training and research under professional supervision</li>
              <li>Gained insights into automotive tech and professional documentation</li>
            </ul>
          </li>
        </ul>
      </div>
      ...
      <div className="about-certifications">
        ...
        <ul>
          ...
          <li><strong>Frontend Development</strong> – HTML, CSS, JavaScript, React (Certificate)</li>
        </ul>
      </div>

      <div className="about-interests">
        <h3 className="about-subtitle">Interests & Achievements</h3>
        <ul>
